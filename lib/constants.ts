...
// --- קבועי ארגון ---
export const SECRETARY_FULL_NAME = "חיה וולס";
...
type TripLogicEntry = {
  ...
  staffLabel: string;
  minRows: number;
  timelineGuideSummary: string;
  timelineGuideSteps: string[];
};
...
export const TRIP_LOGIC: Record<string, TripLogicEntry> = {
    "טיול מחוץ לסניף": {
      nameLabel: "שם הטיול",
      namePlaceholder: "לדוגמה: טיול לצפון",
      timelineTitle: "פירוט הטיול",
      staffLabel: "צוות משתתף בטיול",
      minRows: 2,
      timelineGuideSummary: "הוסיפו שורה לכל שלב לפי סדר הלו״ז: יציאה מהסניף, נסיעות, פעילויות, לינה וחזרה.",
      timelineGuideSteps: [
        "יציאה מהסניף — שורה ראשונה: מיקום «בסניף הקבוע», התרחשות «פעילות ביישוב/מבנה» → «פעילות בסניף».",
        "נסיעות — לכל נסיעה: «התניידות» (נסיעה מאורגנת, רכבת, תחבורה ציבורית, רכבים פרטיים וכו').",
        "פעילויות ביעד — לפי סדר הימים: אטרקציה, אוכל, מסלול בטבע, פעילות ביישוב ועוד.",
        "לינה — אם יש לילה בטיול: «לינה» (מבנה או שטח). התאריך בשורה הבאה יתקדם אוטומטית ליום למחרת.",
        "חזרה — נסיעה חזרה לסניף וסיום הטיול (שוב «התניידות» או «פעילות בסניף»).",
      ],
    },
    "כנס/אירוע מחוץ לסניף": {
      nameLabel: "שם הפעילות",
      namePlaceholder: "לדוגמה: כנס סיום שנה",
      timelineTitle: "פירוט האירוע",
      staffLabel: "צוות משתתף בפעילות",
      minRows: 2,
      timelineGuideSummary: "פרטו את האירוע לפי הסדר: יציאה, נסיעה, האירוע, לינה (אם יש) וחזרה לסניף.",
      timelineGuideSteps: [
        "יציאה מהסניף — מיקום «בסניף הקבוע», התרחשות «פעילות בסניף».",
        "נסיעה לאירוע — «התניידות» (נסיעה מאורגנת, רכבת וכו').",
        "האירוע / הכנס — «פעילות ביישוב/מבנה» → «אירוע באולם» / «כנס» או קטגוריה מתאימה.",
        "לינה — אם האירוע כולל לילה: «לינה» (התאריך יתקדם אוטומטית).",
        "חזרה לסניף — נסיעה חזרה וסיום.",
      ],
    },
    "פעילות לא שגרתית בסניף": {
      nameLabel: "שם הפעילות",
      namePlaceholder: 'לדוגמה: התוועדות יו"ד שבט',
      timelineTitle: "פירוט הפעילות",
      staffLabel: "צוות משתתף בפעילות",
      minRows: 1,
      timelineGuideSummary: "פרטו כל שלב בפעילות בסניף — התכנסות, פעילות, אוכל וכו' — שורה אחר שורה.",
      timelineGuideSteps: [
        "כל הפעילות מתרחשת בסניף — מיקום «בסניף הקבוע».",
        "פרטו כל שלב בנפרד: התכנסות, פעילות, הפסקה, אוכל וכו' — לפי קטגוריות מתאימות (פעילות ביישוב/מבנה, אוכל, אחר).",
        "אם יש יציאה קצרה מהסניף (הליכה, אטרקציה קרובה) — הוסיפו שורת «התניידות» או «מסלול בטבע» עם המיקום המדויק.",
      ],
    },
    "יציאה רגלית באזור הסניף": {
      nameLabel: "שם הפעילות",
      namePlaceholder: "לדוגמה: יציאה למבצעים",
      timelineTitle: "פירוט הפעילות",
      staffLabel: "צוות משתתף בפעילות",
      minRows: 2,
      timelineGuideSummary: "פרטו לפי הסדר: יציאה מהסניף, הליכה/מסלול, פעילות בשטח וחזרה לסניף.",
      timelineGuideSteps: [
        "יציאה מהסניף — שורה ראשונה: «בסניף הקבוע», «פעילות בסניף».",
        "הליכה / מסלול — «התניידות» → «הליכה ביום» או «מסלול בטבע» → «מסלול יום», עם מיקום מדויק.",
        "פעילות בשטח — אטרקציה, אוכל, הפסקה וכו' לפי מה שמתוכנן.",
        "חזרה לסניף — «הליכה ביום» או «פעילות בסניף» לסיום.",
      ],
    },
    "אחר": {
      nameLabel: "שם הפעילות",
      namePlaceholder: 'לדוגמה: טיסה לרבי',
      timelineTitle: "פירוט הפעילות",
      staffLabel: "צוות משתתף בפעילות",
      minRows: 1,
      timelineGuideSummary: "בנו לוח זמנים כרונולוגי — מיציאה ועד סיום, שורה לכל שלב.",
      timelineGuideSteps: [
        "לכל שלב: מיקום → קטגוריית התרחשות → פירוט (נסיעה, פעילות, אוכל, לינה וכו').",
        "לינה מקדימה אוטומטית את התאריך ליום הבא.",
      ],
    },
};
...
export const CATEGORIES: Record<string, { label: string; icon: typeof Bus; color?: string; options: Array<{ label: string; license: boolean }> }> = { 
  transport: { label: 'התניידות', icon: Bus, options: [{ label: 'הליכה ביום', license: false }, { label: 'הליכה בלילה', license: false }, { label: 'נסיעה מאורגנת', license: false }, { label: 'תחבורה ציבורית', license: false }, { label: 'רכבת', license: false }, { label: 'רכבים פרטיים', license: false }, { label: 'אחר', license: false }] }, 
