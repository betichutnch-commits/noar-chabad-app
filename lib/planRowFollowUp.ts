export const PLAN_ROW_FOLLOW_UP_ACTIONS = [
  ...
  { id: "print", label: "עיצוב והדפסה", accentClass: "border-cyan-300 bg-cyan-50 text-cyan-800 hover:bg-cyan-100" },
  { id: "guidelines", label: "הנחיות", accentClass: "border-sky-300 bg-sky-50 text-sky-800 hover:bg-sky-100" },
] as const;

export type PlanRowFollowUpActionId =
  | (typeof PLAN_ROW_FOLLOW_UP_ACTIONS)[number]["id"]
  | "design";
